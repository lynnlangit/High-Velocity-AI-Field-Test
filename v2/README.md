...
## Overview
**v2** represents a next-step refactor of the original prototype (POC), building an even more complete demo, continuing to improve in the key areas of **safety, clarity, and latency**.
